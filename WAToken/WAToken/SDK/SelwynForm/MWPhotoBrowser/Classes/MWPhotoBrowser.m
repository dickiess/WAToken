...
- (void)viewDidLoad {
    ...
    _toolbar = [[UIToolbar alloc] initWithFrame:[self frameForToolbarAtOrientation:barOrientation]];
    _toolbar.tintColor = SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7") ?
    [UIColor colorWithRed:250/255.0 green:250/255.0 blue:250/255.0 alpha:1.0] : nil;
