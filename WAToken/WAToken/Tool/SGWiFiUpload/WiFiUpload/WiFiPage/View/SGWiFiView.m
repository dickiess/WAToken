...
- (NSString *)descTextWithAddress:(NSString *)address {
    NSString *part1 = @"1. 请确保您的iPhone和PC在同一个Wifi环境。\n\n";
//    @"1. Please make sure your iPhone and PC is connected to the same WiFi.\n\n";
    NSString *part2 = @"2. 请用PC浏览器打开下方的URL。\n\n";
//    @"2. Open the URL below in a browser:\n\n";
    NSString *part3 = @"3. 当点击浏览器中Submit按钮后，请耐心等待直至提示传输已经完成。";
//    @"3. When click the submit button on the website, please wait until the page finish loading.";
    return [NSString stringWithFormat:@"%@%@%@\n\n%@", part1, part2, address, part3];
}
