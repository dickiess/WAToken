...
/**
 ...
 @return 表单条目
 */
+ (SelwynFormItem *)itemWithFormTitle:(NSString *)formTitle
                           formDetail:(NSString *)formDetail
                             cellType:(SelwynFormCellType)cellType
                         keyboardType:(UIKeyboardType)keboardType
...
/**
 ...
 @param formTitle 标题
 @param formDetail 详情
 @param placeholder 提示文
 @param cellType cell类型
 @return 表单条目
 */
+ (SelwynFormItem *)detailItemWithFormTitle:(NSString *)formTitle
                                 formDetail:(NSString *)formDetail
...
/**
 ...
 @return 表单条目
 */
NS_INLINE SelwynFormItem *SelwynItemMake(NSString *formTitle,
                                         NSString *formDetail,
                                         SelwynFormCellType cellType,
                                         UIKeyboardType keyboardType,
                                         BOOL editable,
                                         BOOL required) {
    return [SelwynFormHandle itemWithFormTitle:formTitle
...
/**
 ...
 @return 表单条目
 */
NS_INLINE SelwynFormItem *SelwynDetailItemMake(NSString *formTitle,
                                               NSString *formDetail,
                                               NSString *placeholder,
                                               SelwynFormCellType cellType) {
    return [SelwynFormHandle detailItemWithFormTitle:formTitle
                                          formDetail:formDetail
