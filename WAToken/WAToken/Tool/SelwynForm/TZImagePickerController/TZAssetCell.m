...
- (void)setModel:(TZAlbumModel *)model {
    ...
    = [[NSMutableAttributedString alloc] initWithString:model.name attributes:attribute];
    NSAttributedString *countString
    = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"  (%ld)",(long)model.count]
