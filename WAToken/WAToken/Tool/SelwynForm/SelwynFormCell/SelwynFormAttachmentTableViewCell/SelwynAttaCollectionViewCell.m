...
- (void)_setUI {
    ...
    _mainImageView
    = [[UIImageView alloc] initWithFrame:CGRectMake(0, DeleteWidth/2,
                                                    self.frame.size.width - DeleteWidth/2,
                                                    self.frame.size.height - DeleteWidth/2)];
    ...
    _deleteImageView
    = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width - DeleteWidth, 0,
