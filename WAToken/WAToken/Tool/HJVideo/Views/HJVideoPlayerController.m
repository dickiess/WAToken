...
- (void)timerAction {
    ...
    NSLog(@"隐藏底部栏:%ld", (long)self.secondsForBottom);
...
- (void)addObservers{
    ...
    [cent addObserver:self selector:@selector(applicationDidEnterBackground)
                 name:UIApplicationDidEnterBackgroundNotification object:nil];
    
    [cent addObserver:self selector:@selector(applicationWillEnterForeground)
