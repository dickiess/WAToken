...
([SYS_VERSION compare:v options:NSNumericSearch] == NSOrderedAscending)

#define SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(v) \
([SYS_VERSION compare:v options:NSNumericSearch] != NSOrderedDescending)
...
- (void)initUIsize {
    ...
    bottomView.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin |
    ...
    if (_backgroundType == HyPopMenuViewBackgroundTypeDarkBlur ||
        _backgroundType == HyPopMenuViewBackgroundTypeDarkTranslucent ||
        _backgroundType == HyPopMenuViewBackgroundTypeGradient) {
        [bottomView setBackgroundColor:[UIColor colorWithRed:90.f / 225.f
                                                       green:90.f / 225.f
                                                        blue:90.f / 225.f
                                                       alpha:0.9f]];
    }
